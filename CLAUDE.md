...
A local-first LinkedIn feed digester. Full spec: `spec.md`. Approved
architecture and slice plan: `plan.md`. Rationale for the big departures from
the spec: `docs/adr/`. Slice-by-slice progress: `PLAN.md`.
...
- **Collector stays read-only.** No stealth/fingerprint spoofing, no CAPTCHA
  ...
  `spec.md`, not a style preference.
